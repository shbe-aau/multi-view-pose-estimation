...
class NormalShader(nn.Module):
    ...
    def forward(self, fragments, meshes, **kwargs) -> torch.Tensor:
        ...
        print("pix norms: ", pixel_normals.shape)

        colors = pixel_normals #torch.stack([fragments.zbuf,fragments.zbuf,fragments.zbuf]).permute(1,2,3,4,0)
